...
using Personas.DDD.Core.ContributorAggregate;
using Personas.DDD.Core.Interfaces;
using Personas.DDD.Infrastructure;
using Personas.DDD.Infrastructure.Data;
using Personas.DDD.Infrastructure.Email;
using Personas.DDD.UseCases.Contributors.Create;
using FastEndpoints;
...
static void SeedDatabase(WebApplication app)
{
  ...
  try
  {
    ...
    SeedData.Initialize(services); //agrega los valores
  }
  catch (Exception ex)
  {
